...
Вставка осуществляется за O(1) в среднем случае
...
Получение записи выполняется за O(1) в среднем случае
...
Вставка выполняется за O(1) в среднем случае
...
Поиск выполняется за O(1) в среднем случае
